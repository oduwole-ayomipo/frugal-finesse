        ...
        <div className="rounded-sm border border-stroke bg-white shadow-default">
          ...
          <div className="p-7">
            <form action="#">
              ...
              <div
                id="FileUpload"
                className="relative mb-5.5 block w-full cursor-pointer appearance-none rounded border border-purple-6 bg-[#F9F6FF] border-dashed border-primary py-4 px-4"
              >
                <input
                  type="file"
                  accept="image/*"
                ...
                <div className="flex flex-col items-center justify-center space-y-3">
                  ...
                  <p className="font-display">
                    <span className="text-purple-6">Click to upload</span> or
                    drag and drop
                  </p>
                  <p className="mt-1.5 font-display">SVG, PNG, JPG or GIF</p>
                  <p className="font-display">(max, 800 X 800px)</p>
                </div>
              </div>

              <div className="flex justify-end gap-4.5">
                <FilledBtn buttonText={"Save"} />
              </div>
            </form>
          </div>
        </div>
